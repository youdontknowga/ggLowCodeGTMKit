...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "convertTimestampToDayIndex()",
    ...
    "subParams": [
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain. These fields show what will be passed as arguments, not what is configured in this template.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eConvert timestamp to day index\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e19892\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eInvalid input returns undefined\u003c/em\u003e***\u003cbr\u003eInput: \u003cstrong\u003e\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003eundefined\u003c/strong\u003e"
      },
      {
        "type": "LABEL",
...
const convertTimestampToDayIndex = function(timestamp) {
...
// ===============================================================================
// convertTimestampToDayIndex - Direct mode
// ===============================================================================
/*
const applyCast = (castFn, value) => safeFunction(castFn)(value);
const value = applyCast(data.pre, data.src);
return out(convertTimestampToDayIndex(value));
*/
// ===============================================================================
// convertTimestampToDayIndex(...) – Apply Mode
// ===============================================================================
return function(timestamp) {
    return out(convertTimestampToDayIndex(timestamp));
};
...
Created on 03/04/2026, 15:43:24
