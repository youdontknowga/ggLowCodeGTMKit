...
[
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain. These fields show what will be passed as arguments, not what is configured in this template.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eBasic property mapping\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eWith type conversion\u003c/em\u003e***"
      },
      {
        "type": "LABEL",
...
const itemMapProperties = function(arr, mappings) {
...
return out(itemMapProperties(value, pairs));
*/
// ===============================================================================
// itemMapProperties - Apply mode
// ===============================================================================
return function(arr) {
    return out(itemMapProperties(arr, pairs));
};
