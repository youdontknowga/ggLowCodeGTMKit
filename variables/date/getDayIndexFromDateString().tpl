...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "getDayIndexFromDateString()",
  "description": "Returns the index of the day of the week (0 \u003d Sunday, 6 \u003d Saturday) based on an ISO 8601 date string (YYYY-MM-DD). Does not rely on JavaScript\u0027s built-in Date object.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "Returns the index of the day of the week (0 = Sunday, 6 = Saturday) based on an ISO 8601 date string.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eSaturday returns 6\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e2024-11-02\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e0\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eMonday returns 1\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e2024-12-23\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e2\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eInvalid format returns undefined\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e25/12/2024\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003eundefined\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
...
scenarios:
  - name: '[example] Saturday returns 6'
    code: |-
      /* @display
  ...
  - name: '[example] Monday returns 1'
    code: |-
      /* @display
      Value to Process: 2024-12-23
      @output
      2
      */
