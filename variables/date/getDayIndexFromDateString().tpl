...

{
  ...
  "description": "Returns the ISO 8601 day of the week (1 \u003d Monday, 7 \u003d Sunday) from a date string (YYYY-MM-DD). Does not rely on JavaScript\u0027s built-in Date object.",
  "containerContexts": [
    "WEB"
  ]
}
