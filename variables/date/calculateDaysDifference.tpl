    ...
    "subParams": [
      {
        ...
        "help": "▶️   Start date in YYYY-MM-DD format.\u003cbr\u003e\u003cbr\u003e  Supported formats:\u003cbr\u003e \u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eString\u003c/strong\u003e"
      },
      {
        "type": "TEXT",
        "name": "end",
...
return function(value, endDate) {
   endDate = data.rp1 ? endDate : data.end;
