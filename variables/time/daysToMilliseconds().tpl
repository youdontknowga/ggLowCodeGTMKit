...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "daysToMilliseconds()",
    ...
    "subParams": [
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain. These fields show what will be passed as arguments, not what is configured in this template.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eDays to milliseconds\u003c/em\u003e***\u003cbr\u003eInput: \u003cstrong\u003e1\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e86400000\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eZero returns 0\u003c/em\u003e***\u003cbr\u003eInput: \u003cstrong\u003esrc: 0\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e0\u003c/strong\u003e"
      },
      {
        "type": "LABEL",
        "name": "Chained Parameters",
        "displayName": "🔗 Chained callback parameter: Number of Days"
      }
    ],
    "help": "Converts days to milliseconds.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eDays to milliseconds\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e1\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e86400000\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eZero returns 0\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e0\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e0\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
...
const daysToMilliseconds = function(timeValue) {
...
// ===============================================================================
// daysToMilliseconds - Direct mode
// ===============================================================================
/*
const applyCast = (castFn, value) => safeFunction(castFn)(value);
const value = applyCast(data.pre, data.src);
return out(daysToMilliseconds(value));
*/
// ===============================================================================
// daysToMilliseconds() – Apply Mode
// ===============================================================================
