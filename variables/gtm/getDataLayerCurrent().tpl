...
[
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eFull object by event\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003epage_view\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eProperty value by event\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003een\u003c/strong\u003e"
      },
      {
        "type": "LABEL",
        "name": "Chained Parameters",
        "displayName": "🔗 Chained callback parameter: Property Key",
        "enablingConditions": [
          {
            "paramName": "add",
            "paramValue": "dlv",
      ...
      },
      {
        "type": "LABEL",
        "name": "No Parameters",
        "displayName": "🌐 This function takes no parameters – it reads the dataLayer object.",
        "enablingConditions": [
          {
            "paramName": "add",
            "paramValue": "fob",
...
*/
// ===============================================================================
// getDataLayerCurrent() – Apply Mode (key required, returns property value)
// ===============================================================================
if (data.add === 'dlv') {
    return function(key) {
