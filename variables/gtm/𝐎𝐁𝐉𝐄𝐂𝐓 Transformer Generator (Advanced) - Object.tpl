...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "𝐎𝐁𝐉𝐄𝐂𝐓 Transformer Generator (Advanced) - Object",
...
const setter = typeof data.set === 'function' ? data.set : setPath;
...
keyMappings.forEach(mapping => {
    ...
    const transform = safeFunction(mapping.fnc);
