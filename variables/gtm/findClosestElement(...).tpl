...
[
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain. These fields show what will be passed as arguments, not what is configured in this template.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eFind parent by tag name\u003c/em\u003e***\u003cbr\u003eInput: \u003cstrong\u003eStarting Element Path: gtm.element\u003cbr\u003eAttribute to Match: tagName\u003cbr\u003eValue to Match: A\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003egtm.element.parentElement.parentElement\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eNo match returns undefined\u003c/em\u003e***\u003cbr\u003eInput: \u003cstrong\u003eStarting Element Path: gtm.element\u003cbr\u003eValue to Match: A\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003eundefined\u003c/strong\u003e"
      },
      {
        "type": "LABEL",
        "name": "Chained Parameters",
        "displayName": "🔗 Chained callback parameters: Starting Element Path"
      },
      {
        "type": "GROUP",
        ...
        "subParams": [
          {
            "type": "CHECKBOX",
            "name": "rp1",
            "checkboxText": "⚡ Use runtime parameter for: Value to Match",
            "simpleValueType": true
          }
        ]
      }
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "help": "⚙️ Optional function to apply to the result path before returning it. Useful for chaining with \u003cem\u003egetElementAttribute\u003c/em\u003e to directly retrieve an attribute value from the matched element."
      }
    ]
  }
]
