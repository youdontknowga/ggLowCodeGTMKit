...
scenarios:
  - name: '[example] Multiple regex matches'
    code: |-
      /* @display
      Value to Process: /products/category/shoes
      Regex Pattern Table: [
