    ...
    "subParams": [
      {
        "type": "TEXT",
        "name": "min",
        "displayName": "Minuend (From)",
        "simpleValueType": true,
        "help": "💾   The number to subtract from (starting value).\u003cbr\u003e\u003cbr\u003e  Supported formats:\u003cbr\u003e \u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eNumber\u003c/strong\u003e"
      },
      {
        "type": "TEXT",
        "name": "sub",
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "help": "⚙️ Optional pre-processing function applied to the minuend before internal logic (e.g., parse string, apply transformations). Internal transformations will still apply afterward."
      }
    ]
  },
  {
