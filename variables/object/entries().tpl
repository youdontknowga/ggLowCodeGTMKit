...
[
  {
    ...
    "subParams": [
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain. These fields show what will be passed as arguments, not what is configured in this template.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eObject to entries\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[['name', 'John'], ['age', '30'], ['city', 'Paris']]\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eEmpty object returns empty\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[]\u003c/strong\u003e"
      },
      {
        "type": "LABEL",
    ...
    "help": "Returns an \u003cem\u003earray\u003c/em\u003e of [key, value] pairs from an object.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eObject to entries\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e{name: 'John', age: '30', city: 'Paris'}\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[['name', 'John'], ['age', '30'], ['city', 'Paris']]\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eEmpty object returns empty\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e{}\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[]\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
    ...
    "subParams": [
      {
        ...
        "help": "⚙️ Optional function to apply to the result before returning it (e.g., entries =\u003e entries.length, entries =\u003e entries[0] for first entry). Useful for chaining transformations on the output."
      }
    ]
  }
]
