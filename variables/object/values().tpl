...
[
  {
    ...
    "subParams": [
      {
        ...
        "groupStyle": "NO_ZIPPY",
        "subParams": [],
        "help": "Runtime parameters supplied by the function chain. These fields show what will be passed as arguments, not what is configured in this template.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eGet object values\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e['John', 30, 'Paris']\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eEmpty object returns empty\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[]\u003c/strong\u003e"
      },
      {
        "type": "LABEL",
    ...
    "help": "Returns an \u003cem\u003earray\u003c/em\u003e of an object's own values.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eGet object values\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e{name: 'John', age: 30, city: 'Paris'}\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e['John', 30, 'Paris']\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eEmpty object returns empty\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e{}\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[]\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
    ...
    "subParams": [
      {
        ...
        "help": "⚙️ Optional function to apply to the result before returning it (e.g., arr =\u003e arr.join(', '), arr =\u003e arr.length). Useful for chaining transformations on the output."
      }
    ]
  }
]
...
scenarios:
  - name: '[example] Get object values'
    code: |-
      /* @display
      Value to Process: {name: 'John', age: 30, city: 'Paris'}
      @output
      ['John', 30, 'Paris']
      */
