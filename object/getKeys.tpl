    ...
    "subParams": [
      {
        ...
        "help": "💾   The object whose keys are to be retrieved.\u003cbr\u003e\u003cbr\u003e  Supported formats:\u003cbr\u003e \u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eObject\u003c/strong\u003e"
      }
    ],
    "help": "Returns an \u003cem\u003earray\u003c/em\u003e of an object's own keys.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eGet object keys\u003c/em\u003e***\u003cbr\u003eObject Input: \u003cstrong\u003e{name: 'John', age: 30, city: 'Paris'}\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e['name', 'age', 'city']\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eEmpty object returns empty\u003c/em\u003e***\u003cbr\u003eObject Input: \u003cstrong\u003e{}\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e[]\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
    "name": "Input Setup",
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "help": "⚙️ Optional pre-processing function applied to the object before internal logic (e.g., filter properties, normalize structure). Internal transformations will still apply afterward."
      }
    ]
  },
  {
