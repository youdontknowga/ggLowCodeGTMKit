...
[
  {
    ...
    "subParams": [
      {
        ...
        "help": "💾 The source object to pick properties from.\u003cbr\u003e\u003cbr\u003eSupported formats:\u003cbr\u003e\u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eObject variable\u003c/strong\u003e: \u003cem\u003e{{myObject}}\u003c/em\u003e\u003cbr\u003e\u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eObject literal\u003c/strong\u003e"
      },
      {
        "type": "SIMPLE_TABLE",
        "name": "kys",
    ...
    "help": "Returns a new \u003cem\u003eobject\u003c/em\u003e with only the specified keys.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003ePick single property\u003c/em\u003e***\u003cbr\u003eSource Object: \u003cstrong\u003e{name: 'John', age: 30, city: 'Paris', country: 'France'}\u003c/strong\u003e\u003cbr\u003eProperties to Pick: \u003cstrong\u003e[{value: 'name'}]\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003eJohn\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003ePick multiple properties\u003c/em\u003e***\u003cbr\u003eSource Object: \u003cstrong\u003e{id: 1, name: 'Product', price: 99, stock: 50, category: 'electronics'}\u003c/strong\u003e\u003cbr\u003eProperties to Pick: \u003cstrong\u003e[{value: 'name'}, {value: 'price'}, {value: 'category'}]\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003eProduct\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
    "name": "Input Setup",
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "help": "⚙️ Optional pre-processing function applied to the source object before picking properties (e.g., normalize object structure, parse JSON)."
      }
    ]
  },
  {
