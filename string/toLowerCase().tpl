...
scenarios:
  ...
  - name: '[example] Mixed case with special characters'
    code: |-
      /* @display
      Value to Process: Product Name: iPhone 15 PRO Max
      @output
