...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "convertMillisecondsToSeconds",
...
const convertMillisecondsToSeconds = function(timeValue) {
...
// ===============================================================================
// convertMillisecondsToSeconds - Direct mode
// ===============================================================================
const applyCast = (castFn, value) => safeFunction(castFn)(value);
const value = applyCast(data.pre, data.src);
return out(convertMillisecondsToSeconds(value));
// ===============================================================================
// convertMillisecondsToSeconds() – Apply Mode
// ===============================================================================
/*
...
Created on 21/03/2026, 20:36:06
