...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "convertMillisecondsToDays",
...
const convertMillisecondsToDays = function(timeValue) {
...
// ===============================================================================
// convertMillisecondsToDays - Direct mode
// ===============================================================================
const applyCast = (castFn, value) => safeFunction(castFn)(value);
const value = applyCast(data.pre, data.src);
return out(convertMillisecondsToDays(value));
// ===============================================================================
// convertMillisecondsToDays() – Apply Mode
// ===============================================================================
/*
...
Created on 21/03/2026, 20:36:15
