    ...
    "subParams": [
      {
        ...
        "help": "⚙️ Optional function to apply to the result before returning it (e.g., num =\u003e num || 0 to default NaN to 0, num =\u003e num.toFixed(2) for decimal places). Useful for chaining transformations on the output."
      }
    ]
  }
]
