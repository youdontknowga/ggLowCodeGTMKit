...
[
  {
    ...
    "subParams": [
      {
        ...
        "help": "💾 Optional additional numbers to include in the comparison alongside the chained input array.\u003cbr\u003e\u003cbr\u003eSupported formats:\u003cbr\u003e\u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eNumber\u003c/strong\u003e: \u003cem\u003e42\u003c/em\u003e, \u003cem\u003e3.14\u003c/em\u003e\u003cbr\u003e\u0026nbsp;\u0026nbsp;✓ \u003cstrong\u003eVariable reference\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eMinimum of positive numbers\u003c/em\u003e***\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eMinimum with mixed signs\u003c/em\u003e***"
      },
      {
        "type": "GROUP",
    ...
    "help": "Returns the minimum (smallest) value from an array of \u003cem\u003enumbers\u003c/em\u003e.\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eMinimum of positive numbers\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e[{arg: 10}, {arg: 25}, {arg: 15}, {arg: 5}]\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e5\u003c/strong\u003e\u003cbr\u003e\u003cbr\u003e*** \u003cem\u003eMinimum with mixed signs\u003c/em\u003e***\u003cbr\u003eValue to Process: \u003cstrong\u003e[{arg: -10}, {arg: 0}, {arg: 15}, {arg: -3}, {arg: 8}]\u003c/strong\u003e\u003cbr\u003e↪️ Output: \u003cstrong\u003e-10\u003c/strong\u003e"
  },
  {
    "type": "GROUP",
...
scenarios:
  - name: '[example] Minimum of positive numbers'
    code: |
      /* @display
      Value to Process: [{arg: 10}, {arg: 25}, {arg: 15}, {arg: 5}]
      @output
      5
      */
  ...
  - name: '[example] Minimum with mixed signs'
    code: |
      /* @display
      Value to Process: [{arg: -10}, {arg: 0}, {arg: 15}, {arg: -3}, {arg: 8}]
      @output
      -10
      */
